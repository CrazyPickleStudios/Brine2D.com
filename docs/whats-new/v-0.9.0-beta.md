...
- ❌ `StopChannel(int)`
- ❌ `PauseChannel(int)`
- ❌ `IsChannelPlaying(int)`
- ✅ Use `PlaySoundWithTrack()` and `StopTrack(nint)` instead
...
**Major Changes:**
- ✅ .NET 10 support
- ✅ Package separation (Brine2D + Brine2D.SDL)
- ✅ Track-based audio system
- ✅ Performance monitoring
- ✅ GPU renderer improvements
- ✅ Post-processing effects
...
**Breaking Changes:**
- ⚠️ Namespace reorganization
- ⚠️ Audio API changes (channel → track)
- ⚠️ Service registration names
- ⚠️ Backend enum values
